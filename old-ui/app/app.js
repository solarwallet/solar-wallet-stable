  ...
  return (
    h('.flex-column.full-height', {
      style: {
        ...
        position: 'relative',
        alignItems: 'center',
        background: (props.isUnlocked || props.currentView.name === 'restoreVault' || props.currentView.name === 'config') ? 'white' : 'linear-gradient(#246A73, #246A73)',
      },
    }, [
      h(AppBar, {
        ...this.props,
      ...
      h('.app-primary' + (transForward ? '.from-right' : '.from-left'), {
        style: {
          background: (props.isUnlocked || props.currentView.name === 'restoreVault' || props.currentView.name === 'config') ? confirmMsgTx ? 'linear-gradient(#246A73, #246A73)' : 'white' : 'transparent',
